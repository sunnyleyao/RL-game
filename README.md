# Tiny Survivor
This is a reinforcement learning game. The game happens in a a custom grid-world where a hamster learns to collect food and avoid traps using two RL algorithms: tabular Q-Learning and Deep Q-Network (DQN). No rules were given to the agents, and they learned entirely through trial and error.
